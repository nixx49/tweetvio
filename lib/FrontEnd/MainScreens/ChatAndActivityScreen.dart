...
import 'package:tweetvio/FrontEnd/Services/ChatManagement/chat_screen.dart';
import 'package:tweetvio/FrontEnd/Services/search_screen.dart';
import 'package:tweetvio/GlobalUser/constants.dart';
...
class _ChatAndActivityScreenState extends State<ChatAndActivityScreen> {
  ...
  final List<String> _allUserConnectionActivity = ['Tweetvio', 'Nimantha'];
  final List<String> _allConnectionsUserName = ['Yenuli', 'Mandakini', 'Rashmi', 'Kalindu', 'Lakitha', 'Nadun',];
  ...
  Future<void> _fetchRealTimeDataFromCloudStorage() async{
    final realTimeSnapshot = await this._cloudStoreDataManagement.fetchRealTimeDateFromFirestore();
...
*/
  ...
  Widget chatTileContainer(BuildContext context, int index, String _userName) {
    return Card(
        key: Key('$index'),
        elevation: 0.0,
        color: const Color.fromRGBO(7, 0, 26, 1),
        child: Container(
          //padding: EdgeInsets.only(left: 1.0, right: 1.0),
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              elevation: 0.0,
              primary: Color.fromRGBO(7, 0, 26, 1),
                  ...
                  child: OpenContainer(
                    ...
                    closedBuilder: (_, __) {
                      return CircleAvatar(
                        ...
                        backgroundImage:
                        ExactAssetImage('assets/images/setup.png'),
...
//                          _latestDataForConnectionExtractPerfectly(_userName)
  ...
  Widget _externalConnectionManagement() {
    return OpenContainer(
      closedColor: const Color.fromRGBO(153, 0, 153, 1),
      middleColor: const Color.fromRGBO(7, 0, 26, 1),
      openColor: const Color.fromRGBO(7, 0, 26, 1),
      closedShape: CircleBorder(),
