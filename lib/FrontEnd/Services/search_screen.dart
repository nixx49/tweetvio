      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Text(this._availableUsers[index].values.first.toString().split(
                  '[user-name-about-divider]') [0],
                style: TextStyle(color: Colors.white, fontSize: 20),),
              Text(this._availableUsers[index].values.first.toString().split(
                  '[user-name-about-divider]') [1],
          ...
          TextButton(
            ...
            child: _getRelevantButtonConfig(connectionStateType: ConnectionStateType.ButtonName, index: index),
            onPressed: () {
      ...
      return Colors.yellow;
        ...
        if (connectionStateType == ConnectionStateType.ButtonNameWidget)
          return Text(
           ...
           // _storeStatus == OtherConnectionStatus.Request_Accepted.toString()?'Pending':'Accept',
