...
class LocalDatabase {
  ...
  /// Getter for taking instance of databas
  ...
  Future<Database> initializeDatabase() async {
    ...
    final Directory newDirectory =
        await Directory(desirePath + '/.Database/').create();
    final String path = newDirectory.path + '/tweetvio_local_storage.db';
 ...
 /* Future<bool> createTableForUserActivity({required String tableName}) async {
  ...
  Future<void> insertMessageInUserTable(
      {required String userName,
        ...
        required String messageHolderType,
